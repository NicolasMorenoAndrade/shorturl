...
(def styles
  {:container "bg-lime-100 grid place-items-center h-screen p-2"
   ...
   {:container "absolute top-2 right-2"
    ...
    :user-icon-unclicked "h-6 w-6 rounded-full bg-lime-100 cursor-pointer flex items-center justify-center text-lime-700 text-xs font-bold"
   ...
   {:container "text-center"
    ...
    :button "mt-6 w-full bg-lime-600 hover:bg-lime-700 text-white py-2 px-4 rounded transition-colors duration-200 cursor-pointer"}
